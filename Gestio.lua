...
-- Version: 5.4.7 Enterprise Execution Order Fixed Edition
...
task.defer(function()
    ...
    -- ==========================================
    -- FLOATING UI LAUNCHER & PAGES DECLARATION
    -- ==========================================
    ...
    -- CORRECT PAGE DECLARATION ORDER
    ...
    local function openInspectorFor(moduleName)
        ...
        elseif moduleName == "Anti-Aim" then
            ...
            addInspectorSlider(6, "Spin Speed", 10, 150, spinSpeed, false, function(v) spinSpeed = v end)
        elseif moduleName == "Auto Strafe" then
            insContent.CanvasSize = UDim2.new(0, 0, 0, 100)
            addInspectorSlider(6, "Strafe Strength", 0.1, 2.0, strafeStrength, true, function(v) strafeStrength = v end)
    ...
    -- Tab Population (Pages are already initialized)
